...
// node_modules/angular-split/fesm2015/angular-split.mjs
...
var SplitComponent = class {
  ...
  get transitionEnd() {
    return new import_rxjs.Observable((subscriber) => this.transitionEndSubscriber = subscriber).pipe((0, import_operators.debounceTime)(20));
  }
  constructor(ngZone, elRef, cdRef, renderer, globalConfig) {
    ...
    this.dragProgressSubject = new import_rxjs.Subject();
